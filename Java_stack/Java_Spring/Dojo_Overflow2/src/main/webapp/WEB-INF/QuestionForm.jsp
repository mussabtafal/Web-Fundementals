            ...
            <div class = "col-7 align-self-center m-5">
                <form action="/questions/new" method="post">
                    <div class="form-floating mb-4">
                      ...
                      <p class="error"><c:out value="${errorTagQ}"></c:out></p>
                    </div>
                    <div class="form-floating my-3">
                      <input name ="tags" class="form-control" id="floatingInput" placeholder="name@example.com"/>
                      <label for="floatingInput">Tags:</label>
                      <p class="error"><c:out value="${errorTag}"></c:out></p>
                    </div>
