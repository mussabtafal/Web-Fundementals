    	...
    	<h5>Join our growing community</h5>
            <div class = "col-5 mt-5">
                ...
                <form:form action="/register" method="post" modelAttribute="newUser">
                    ...
                    <div class="form-floating my-3">
                      <form:input type="date" path="birthday" value = "" class="form-control" name = "birthday" id="floatingInput" placeholder="name@example.com"/>
                      <form:label path="birthday" for="floatingInput">Birthday:</form:label>
                        <form:errors path="birthday" class = "my-3" style="color: red;"/>
                    </div>
                    <div class="form-floating my-3">
